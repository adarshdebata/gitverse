  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        {sidebarOpen && (
          <div className="animate-fade-in">
            <div className="font-heading" style={{ fontSize: 15, fontWeight: 800, color: 'var(--text)' }}>
              GitVerse
            </div>
          ...
          <div key={si}>
            ...
            {section.items.map(item => (
              ...
              >
                ...
                {sidebarOpen && (
                  <span className="animate-fade-in" style={{ whiteSpace: 'nowrap', overflow: 'hidden' }}>
                    {item.label}
                  </span>
                )}
              </NavLink>
      ...
      <div style={{
        ...
        {sidebarOpen && (
          <div className="animate-fade-in font-mono" style={{
            fontSize: 9, color: 'var(--dim)', textAlign: 'center', padding: '4px 0',
          }}>
