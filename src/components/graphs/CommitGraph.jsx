 ...
 * CommitGraph
 * @param {object} props
 * @param {string}  props.scenario     - key from GRAPHS data
 * @param {object}  props.customGraph  - override with custom {nodes, edges, head, branches}
 * @param {boolean} props.animated     - enable node/line entrance animations
 * @param {boolean} props.showLabels   - show branch labels
 * @param {boolean} props.showHead     - show HEAD pointer
