  ...
  return (
    <div className="animate-fade-up">
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 240 }}>
          ...
          >
            <h1
              ...
              style={{ fontSize: "clamp(22px,4vw,32px)", fontWeight: 900 }}
            >
              {cmd.name}
            </h1>
        ...
        <button className="btn" style={{ flexShrink: 0 }} onClick={() => navigate("/commands")}>
          ← Back
        </button>
      </div>
      ...
      {tab === "overview" && (
        <div className="animate-fade-in">
          ...
          >
            ...
            <div
              className="gitverse-card"
              style={{ padding: 16, borderColor: "rgba(244,63,94,0.3)" }}
            >
              <div
                style={{
                  fontWeight: 700,
              ...
              <div key={i} style={{ marginBottom: 14 }}>
                <div style={{ display: "flex", alignItems: "flex-start", gap: 10 }}>
                  ...
                  >
                    ...
                    {s.deprecated && (
                      <Badge variant="deprecated" style={{ marginLeft: "auto" }}>
                        deprecated
                      </Badge>
                    )}
                  </div>
      ...
      {tab === "internals" && (
        <div className="animate-fade-in">
          ...
          <CodeBlock
            code={`# Inspect the object database directly
...
ls .git/refs/heads/         # see all branch refs`}
            style={{ marginBottom: 16 }}
          />

          {cmd.danger !== "safe" && (
            <Alert type="danger">
              <strong>SHA implication:</strong> {cmd.name} rewrites commit objects. New SHAs are
              generated. Anyone who has fetched the old SHAs must rebase their work — this is why
              force-pushing rewrites breaks teams.
            </Alert>
          )}
        </div>
      )}
        ...
        <div className="animate-fade-in">
          ...
          {cmd.recovery && (
            <div>
              ...
              <div
                className="gitverse-card"
                style={{ padding: 16, borderLeft: "3px solid var(--emerald)" }}
              >
                <pre
                  style={{
                    fontFamily: "IBM Plex Mono",
