      ...
      <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <p style={{
            ...
            Every command animated. Every concept interactive. Built for senior engineers
            who want to understand Git deeply — not just use it.
            From SHA internals to enterprise recovery workflows.
          </p>
        ...
        <div>
          ...
          <button
            ...
            style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'var(--cyan)',
              textDecoration: 'underline', padding: 0, fontSize: 'inherit' }}
          >
            Terminal Playground
          </button>
          {' '}to experiment safely — a full simulated Git repository with realistic output,
          command history (↑↓), and Tab autocomplete. No risk to real repos.
        </div>
      </Alert>
    </div>
  )
